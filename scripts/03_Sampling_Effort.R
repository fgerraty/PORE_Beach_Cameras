...
summarized_detections_monthly_wide <- summarized_detections_monthly %>% 
...
#Export sampling effort datasets
write_csv(summarized_detections_monthly, 
          "data/processed/summarized_detections_monthly.csv")   
write_csv(summarized_detections_monthly_wide, 
          "data/processed/summarized_detections_monthly_wide.csv")   
write_csv(summarized_detections_weekly, 
          "data/processed/summarized_detections_weekly.csv")   
write_csv(summarized_detections_weekly_wide, 
          "data/processed/summarized_detections_weekly_wide.csv")   
